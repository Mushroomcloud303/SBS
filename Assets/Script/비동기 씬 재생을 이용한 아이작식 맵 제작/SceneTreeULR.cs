...
public class SceneTreeULR : SceneTree
{
    protected override IEnumerator SetLeafSequence(Vector2 direction, SceneTree rootTree)
    {
        ...
        switch (direction)
        {
            case Vector2 left when direction == Vector2.left:
                ...
                //Debug.Log("위쪽 트리 설치");
                //yield return StartCoroutine(LoadAndPositionScene(Vector2.down * 36, this, (sceneTree) => this.downTree = sceneTree));
                //Debug.Log("아래쪽 트리 설치");
                break;
            ...
            case Vector2 right when direction == Vector2.right:
                ...
                //Debug.Log("왼쪽 트리 설치");
                yield return StartCoroutine(LoadAndPositionSceneUsingDir(Vector2.right, Vector2.right * 38, this, (sceneTree) => this.rightTree = sceneTree));
                //Debug.Log("오른쪽 트리 설치");
                yield return StartCoroutine(LoadAndPositionSceneUsingDir(Vector2.up, Vector2.up * 36, this, (sceneTree) => this.upTree = sceneTree));
                //Debug.Log("위쪽 트리 설치");
                //yield return StartCoroutine(LoadAndPositionScene(Vector2.down * 36, this, (sceneTree) => this.downTree = sceneTree));
